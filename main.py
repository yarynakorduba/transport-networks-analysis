...
from Visualization import compute_areas_under_the_curve
...
# TODO: change
lviv_routes_dataset = "./data/lviv_parsed/processed/lvivAllRoutesProcessed40m.json"
...
# print(lviv_space_features.number_of_edges())
# print(lviv_space_features.mean_degree())
# print(lviv_space_features.mean_shortest_path())
# print(lviv_space_features.max_shortest_path())
# print(lviv_space_features.graph_assortativity())
print(lviv_space_features.mean_betweenness_centrality())
# print(lviv_space_features.mean_clustering_coefficient())


bristol_stops_dataset = "./data/bristol_parsed/processed/bristolAllStopsProcessed40m.json"
bristol_routes_dataset = "./data/bristol_parsed/processed/bristolAllRoutesProcessed40m.json"
...
print(bristol_space_features.mean_betweenness_centrality())
